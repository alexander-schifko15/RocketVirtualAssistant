...
from_language, to_languages = 'en-US', [ 'de','zh-Hans', 'ja','es','fr','ar']
...
# End Of main window
    ...
    def play_translationzh():
            filename = "zh-Hans-translation.wav"
            data, fs = sf.read(filename, dtype='float32')  
            sd.play(data, fs)
            status = sd.wait() 
    def play_translationde():
            filename = "de-translation.wav"
            data, fs = sf.read(filename, dtype='float32')  
            sd.play(data, fs)
            status = sd.wait() 
    def play_translationja():
            filename = "ja-translation.wav"
            data, fs = sf.read(filename, dtype='float32')  
            sd.play(data, fs)
            status = sd.wait() 
    def play_translationes():
            filename = "es-translation.wav"
            data, fs = sf.read(filename, dtype='float32')  
            sd.play(data, fs)
            status = sd.wait() 
    def play_translationfr():
            filename = "fr-translation.wav"
            data, fs = sf.read(filename, dtype='float32')  
            sd.play(data, fs)
            status = sd.wait() 
    def play_translationar():
            filename = "ar-translation.wav"
            data, fs = sf.read(filename, dtype='float32')  
            sd.play(data, fs)
            status = sd.wait() 
